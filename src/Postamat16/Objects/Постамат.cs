...
namespace IIS.Postamat16
{
    ...
    public class Постамат : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat16.Статусы fСтатус;
        
        private IIS.Postamat16.СлужбаДоставки fСлужбаДоставки;
        
        private IIS.Postamat16.DetailArrayOfРегистрХран fРегистрХран;
        ...
        public virtual IIS.Postamat16.Статусы Статус
        {
            get
            {
                ...
                IIS.Postamat16.Статусы result = this.fСтатус;
        ...
        [PropertyStorage(new string[] {
                "СлужбаДоставки"})]
        [NotNull()]
        public virtual IIS.Postamat16.СлужбаДоставки СлужбаДоставки
        {
            get
            {
                ...
                IIS.Postamat16.СлужбаДоставки result = this.fСлужбаДоставки;
        ...
        public virtual IIS.Postamat16.DetailArrayOfРегистрХран РегистрХран
        {
            get
            {
                ...
                {
                    this.fРегистрХран = new IIS.Postamat16.DetailArrayOfРегистрХран(this);
                }
                IIS.Postamat16.DetailArrayOfРегистрХран result = this.fРегистрХран;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПостаматE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматE", typeof(IIS.Postamat16.Постамат));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПостаматL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПостаматL", typeof(IIS.Postamat16.Постамат));
                }
            }
        }
    }
