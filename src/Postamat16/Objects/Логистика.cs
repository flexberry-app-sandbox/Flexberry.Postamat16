...
namespace IIS.Postamat16
{
    ...
    [View("ЛогистикаE", new string[] {
            ...
            "СлужбаДоставки.Наименвоание as \'Наименование службы доставки\'"}, Hidden=new string[] {
    ...
    public class Логистика : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat16.Состояние fСостояние;
        ...
        public virtual IIS.Postamat16.Состояние Состояние
        {
            get
            {
                ...
                IIS.Postamat16.Состояние result = this.fСостояние;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЛогистикаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаE", typeof(IIS.Postamat16.Логистика));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЛогистикаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаL", typeof(IIS.Postamat16.Логистика));
                }
            }
        }
    }
