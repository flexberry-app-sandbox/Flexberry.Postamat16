...
namespace IIS.Postamat16
{
    ...
    public class РегистрХран : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat16.Постамат fПостамат;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Postamat16.Постамат.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Постамат"})]
        public virtual IIS.Postamat16.Постамат Постамат
        {
            get
            {
                ...
                IIS.Postamat16.Постамат result = this.fПостамат;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистрХранE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистрХранE", typeof(IIS.Postamat16.РегистрХран));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРегистрХран : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Postamat16.DetailArrayOfРегистрХран members)

        // *** End programmer edit section *** (IIS.Postamat16.DetailArrayOfРегистрХран members)
        ...
        /// </summary>
        public DetailArrayOfРегистрХран(IIS.Postamat16.Постамат fПостамат) : 
                base(typeof(РегистрХран), ((ICSSoft.STORMNET.DataObject)(fПостамат)))
        {
        }
        
        public IIS.Postamat16.РегистрХран this[int index]
        {
            get
            {
                return ((IIS.Postamat16.РегистрХран)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Postamat16.РегистрХран dataobject)
        {
