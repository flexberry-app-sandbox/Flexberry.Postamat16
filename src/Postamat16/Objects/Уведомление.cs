...
namespace IIS.Postamat16
{
    ...
    [View("УведомлениеL", new string[] {
            ...
            "НомерТелефона as \'Номер телефона пользователя\'",
            "Номер as \'Номер посылки\'",
            "Хранение.Продления as \'Продление посылки\'",
            "Хранение.ДатаНачала as \'Дата начала хранения\'",
            "Хранение.ДатаЗавершения as \'Дата завершение хранения\'"})]
    public class Уведомление : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View УведомлениеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УведомлениеE", typeof(IIS.Postamat16.Уведомление));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УведомлениеL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УведомлениеL", typeof(IIS.Postamat16.Уведомление));
                }
            }
        }
    }
