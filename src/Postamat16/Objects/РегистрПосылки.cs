...
namespace IIS.Postamat16
{
    ...
    [View("РегистрПосылкиE", new string[] {
            ...
            "Посылка.Пользователь.ФИО as \'ФИО пользователя\'",
            "Посылка.Логистика.Состояние as \'Состояние доставки\'"}, Hidden=new string[] {
            "Посылка.Номер"})]
    ...
    public class РегистрПосылки : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat16.Хранение fХранение;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Postamat16.Хранение.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Хранение"})]
        public virtual IIS.Postamat16.Хранение Хранение
        {
            get
            {
                ...
                IIS.Postamat16.Хранение result = this.fХранение;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистрПосылкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистрПосылкиE", typeof(IIS.Postamat16.РегистрПосылки));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРегистрПосылки : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Postamat16.DetailArrayOfРегистрПосылки members)

        // *** End programmer edit section *** (IIS.Postamat16.DetailArrayOfРегистрПосылки members)
        ...
        /// </summary>
        public DetailArrayOfРегистрПосылки(IIS.Postamat16.Хранение fХранение) : 
                base(typeof(РегистрПосылки), ((ICSSoft.STORMNET.DataObject)(fХранение)))
        {
        }
        
        public IIS.Postamat16.РегистрПосылки this[int index]
        {
            get
            {
                return ((IIS.Postamat16.РегистрПосылки)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Postamat16.РегистрПосылки dataobject)
        {
